...
export default function CotizadorPage() {
    ...
    return (
        ...
        <div className="min-h-screen bg-[#050505] text-white flex flex-col items-center justify-center relative selection:bg-[#1ed760] selection:text-black font-sans pb-16 md:pb-0 overflow-hidden">
            ...
            {/* 🌌 CAPA DE FONDO (Controla la opacidad acá sin romper los textos) */}
            <div
                className="absolute inset-0 bg-[url('/banner-piso.png')] bg-cover bg-center opacity-40 pointer-events-none z-0"
            />

            {/* 🎛️ OVERLAY GRADIENTE (Opcional, para que se fusione sutilmente con el negro de las esquinas) */}
            ...
            <div className="w-full max-w-4xl p-6 relative z-10">
                ...
                <div className="fixed bottom-0 w-full flex max-w-4xl justify-between items-center p-4 text-[10px] text-gray-700 z-0">
                    ...
                    <button
                        ...
                        className="w-8 h-8 flex items-end justify-end outline-none hover:opacity-40 transition-opacity"
                    >
                        <Lock size={16} />
                    </button>
                </div>
