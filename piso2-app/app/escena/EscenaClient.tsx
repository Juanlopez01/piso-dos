...
export default function EscenaClient({ carteleraIniciales, convocatoriasIniciales }: { carteleraIniciales: any[]; convocatoriasIniciales: any[] }) {
    const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false)
    const [lightboxImg, setLightboxImg] = useState<string | null>(null)
    const [loggedUser, setLoggedUser] = useState<any>(null)
    // Datos renderizados en el servidor (SEO + sin flash de carga).
