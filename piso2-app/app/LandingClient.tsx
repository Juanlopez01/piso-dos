...
export default function LandingClient({ carteleraIniciales }: { carteleraIniciales: any[] }) {
  const [activeSection, setActiveSection] = useState<'2m' | '2e' | '2s'>('2m')
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false)
  const [loggedUser, setLoggedUser] = useState<any>(null)
  // Cartelera renderizada en el servidor (SEO + sin skeleton inicial).
        ...
        <div className="max-w-7xl mx-auto min-h-[500px] relative">
          ...
          <div className={`transition-all duration-700 absolute inset-0 grid grid-cols-1 md:grid-cols-2 ${activeSection === '2s' ? 'opacity-100 z-10' : 'opacity-0 z-0 pointer-events-none'}`}>
            ...
            <div className="p-10 md:p-16 flex flex-col justify-center">
              ...
              <div><a href='/streaming'><button className="inline-flex items-center gap-3 border border-white/20 hover:border-[#D4E655] text-white font-bold uppercase px-8 py-4 text-xs tracking-[0.2em] transition-colors">CONSULTAR</button></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto relative z-10 flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
            ...
            <div className="bg-[#09090b]/60 backdrop-blur-md border border-white/5 hover:border-[#D4E655]/30 rounded-3xl p-10 flex flex-col items-center text-center transition-all duration-300">
              ...
              <a href="https://wa.me/5491171190301" target="_blank" rel="noreferrer" className="mt-auto w-full md:w-auto inline-flex items-center justify-center gap-3 border border-white/20 hover:border-[#D4E655] text-[#D4E655] font-black uppercase px-8 py-3.5 text-xs tracking-[0.2em] rounded-xl hover:bg-white/5 transition-all">
