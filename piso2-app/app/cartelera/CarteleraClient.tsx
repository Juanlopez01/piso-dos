...
import { type ClasePublicaGrupo } from '@/app/actions/cartelera'
...
export default function CarteleraClient({ gruposIniciales }: { gruposIniciales: ClasePublicaGrupo[] }) {
    // Los datos vienen ya renderizados del servidor (SEO + sin spinner inicial).
    const [grupos] = useState<ClasePublicaGrupo[]>(gruposIniciales)
