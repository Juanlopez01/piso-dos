    ...
    return (
        <div className="min-h-screen bg-neutral-50 text-neutral-900">
            ...
            <div className="max-w-lg mx-auto px-5 py-8">
                <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.25em] text-neutral-400 mb-1"><Theater size={14} /> Convocatoria de obras</div>
                <h1 className="text-2xl md:text-3xl font-black tracking-tight">Proponé tu obra en Piso 2</h1>
